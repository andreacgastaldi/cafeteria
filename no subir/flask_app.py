...
#  const URL = "https://cafeteria22.pythonanywhere.com/"
#Database host address:cafeteria22.mysql.pythonanywhere-services.com
#Username:cafeteria22
#Name:cafeteria22$default
#catalogo = Catalogo(host='localhost', user='root', password='', database='menu')

catalogo = Catalogo(host='cafeteria22.mysql.pythonanywhere-services.com', user='cafeteria22', password='pampa2024', database='cafeteria22$menu')
